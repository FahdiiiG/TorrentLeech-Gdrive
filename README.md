...
e)It should look like `app.json`. 🎉
    ...
    REMOVING THE WELCOME  MESSAGE [OPTIONAL]
    1. Go to torbot > plugins.
    3. Open "new_join_fn.py" and Edit it.
    4. In Line number 41, delete the following only:
       join this group forr help-- @GbotStoreSupport\n\n And also don't forget to fork this repo: <a href="https://github.com/gautamajay52/TorrentLeech-Gdrive">TorrentLeech-Gdrive</a>
    5. After removing you will see - """ """
